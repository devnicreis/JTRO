    ...
    <div id="bloco_responsaveis" class="form-secao" style="display:none;">
        ...
        <div class="grid">
            ...
            <div class="campo">
                ...
                <input type="text" id="responsavel_1_nome" name="responsavel_1_nome" pattern="^[\p{L}\s]+$" value="<?php echo htmlspecialchars($_POST['responsavel_1_nome'] ?? ''); ?>">
            </div>
        </div>
        ...
        <div id="bloco_segundo_responsavel" class="grid" style="display:none;">
            ...
            <div class="campo">
                ...
                <input type="text" id="responsavel_2_nome" name="responsavel_2_nome" pattern="^[\p{L}\s]+$" value="<?php echo htmlspecialchars($_POST['responsavel_2_nome'] ?? ''); ?>">
            </div>
        </div>
    </div>
